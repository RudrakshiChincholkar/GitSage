  ...
  const docSections: DocSection[] = [
    {
      ...
      title: 'Overview',
      icon: FileText,
      content: 'This repository contains a modern web application built with React and TypeScript. The project follows industry best practices with a component-based architecture, comprehensive testing, and automated deployment pipelines.',
    },
    {
      id: 'architecture',
      title: 'Architecture',
      icon: Layers,
      content: 'The application is structured using a modular architecture with clear separation of concerns. The frontend is built with React and uses Redux for state management. The component hierarchy follows atomic design principles, with atoms, molecules, and organisms clearly defined.',
    },
    {
      id: 'setup',
    ...
    },
    {
      ...
      icon: Package,
      content: 'The project relies on several core dependencies:\n\n• React 18.x - UI library\n• TypeScript 5.x - Type safety\n• Vite - Build tool and dev server\n• Tailwind CSS - Styling\n• React Router - Navigation\n• Zustand - State management',
    },
    {
      id: 'api',
      title: 'API Reference',
      icon: Code,
      content: 'The main API endpoints are organized by feature:\n\n• /api/auth - Authentication endpoints\n• /api/users - User management\n• /api/data - Data operations\n\nAll endpoints return JSON and use standard HTTP status codes. Authentication is handled via JWT tokens.',
    },
    {
      id: 'contributing',
      title: 'Contributing',
      icon: BookOpen,
      content: 'Contributions are welcome! Please follow these guidelines:\n\n1. Fork the repository and create a feature branch\n2. Write tests for new functionality\n3. Ensure all tests pass with `npm test`\n4. Submit a pull request with a clear description\n5. Follow the existing code style and conventions',
    },
  ];
